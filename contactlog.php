            ...
            <form action="" method="post">
              <div class="contact_form-container">
                <div>
                  ...
                  ?>
                  <div>
                    <input type="text" value="<?php echo $row['fname'] . ' '. $row['lname']; ?>" placeholder="Name" />
                  </div>
                  <div>
                    <input type="email" value="<?php echo $row['email']; ?>" placeholder="Email" />
                  </div>
                  <div>
                    <input type="text" value="<?php echo $row['phone']; ?>" placeholder="Phone Number" />
                  </div>
                  <?php
                    }
                  ?>
          ...
          <div class="col-md-6">
            <div class="map_container">
              <div class="map-responsive">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30506.120839364004!2d80.58995209760994!3d17.108563025685854!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a34328b7ced6f0f%3A0x9a112d76822917af!2sTiruvuru%2C%20Andhra%20Pradesh%20521235!5e0!3m2!1sen!2sin!4v1683362627975!5m2!1sen!2sin"
